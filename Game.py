...
"\n"
"To play the game you will choose an attack against the computer. The attacks are Rocks, Paper or Scissors.\n"
"The computer will also choose an attack against you.\n"
"Rock beats Scissors. Scissors beats Paper. Paper beats Rock.\n"
"Whoever beats the other gets a point.\n"
"Best out of 3 and first to 2 wins the game.\n"
"\n"
...
while play:
    ...
    while computer_score < 2 or player_score < 2:
        ...
        while True:
            choices = {"R": "You have chosen rock.\n", "P": "You have chosen paper.\n",
            ...
            if player_choice == "P":
                ...
                while True:
                    ...
                    if end_game.upper() == "Y":
                        ...
                        sys.exit()
                    elif end_game.upper() == "N":
                        print("OK let's keep playing!")
                        break
                    else:
